...
const Reviews = () => {
  ...
  return (
    <section className="py-24 bg-emerald-950 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-96 h-96 bg-emerald-900/30 rounded-full blur-3xl -mr-48 -mt-48"></div>
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-green-900/20 rounded-full blur-3xl -ml-48 -mb-48"></div>

      <div className="max-w-6xl mx-auto px-6 relative z-10 text-center">
        <span className="text-emerald-400 font-semibold tracking-widest uppercase text-sm">
          Testimonials
        </span>
        <h2 className="text-4xl md:text-5xl font-serif font-bold text-white mt-3 mb-16">
          What Our Guests <span className="text-emerald-500 italic">Say</span>
        </h2>
